    ...
    this.createMany = function(d){
            ...
            */
            ...
            function scroll(e){
                ...
                var max = Math.min(100,window[id]/elementHeight);
                    ...
                    for (var i = s-1; i < s+max; i++) {
                        if (d.values[i] != 0 && !d.values[i]) {
                            ...
                            var element = d.getNode(d.values[i],i);
                            element.class({
                                position: "absolute",
                                top: Number(elementHeight*i).toString() + "px",
                            });
                            elements.push(element);
                            nodeForScroll.append(element);
                    };
            };
